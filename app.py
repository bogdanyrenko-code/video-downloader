...
def get_rutube_video_info(url):
    """Получает информацию о видео с RuTube"""
...
# ---------- YouTube и другие платформы ----------
def get_video_info(url):
    """Получает информацию о видео с различных платформ"""
    if 'rutube.ru' in url:
...
def index():
    ...
    return render_template_string(
        ...
        max_downloads=MAX_FREE_DOWNLOADS_PER_DAY
    )
